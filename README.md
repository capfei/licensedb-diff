...
exception text matches against AboutCode's ScanCode LicenseDB list: https://scancode-licensedb.aboutcode.org/index.html.
LicenseDB includes identifiers, license text and exception text from AboutCode, SPDX and OSI.
